...
| [shared-services.md](shared-services.md) | `scope = "shared"`: one instance for the repository, one tenant per worktree, and why the job table is the reference count |
